<%@ Page Title="" Language="C#" MasterPageFile="MasterPageCG.Master" AutoEventWireup="true" CodeBehind="ProcuraReceitaCG.aspx.cs" Inherits="CHEF_GATO_WEB2.ProcuraReceita" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Button ID="Button3" runat="server" Text="Procurar" OnClick="Button3_Click1" />
